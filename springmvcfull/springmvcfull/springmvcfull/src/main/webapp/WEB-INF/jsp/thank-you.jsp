...
<head>
<meta charset="utf-8">
<title>Thank you ${newStudent.firstName}!</title>
...
<p class="lead">Thank you ${newStudent.firstName}
${newStudent.lastName} for signing up for this test page.</p>
<p class="lead">You can sign into your account using the email
${newStudent.email} and password.</p>
<p class="lead">
